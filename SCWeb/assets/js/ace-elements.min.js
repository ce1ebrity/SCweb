...
function (e) {
    ...
    e.fn.ace_tree = function (a) {
        ...
        this.each(function () {
            var a = e(this);
            a.html('<div class="tree-folder" style="display:none;">\t\t\t\t<div class="tree-folder-header">\t\t\t\t\t<i class="' + ace.vars.icon + t['close-icon'] + '"></i>\t\t\t\t\t<i class="' + ace.vars.icon + t['unselected-icon'] + '"></i>\t\t\t\t\t<div class="tree-folder-name"></div>\t\t\t\t</div>\t\t\t\t<div class="tree-folder-content"></div>\t\t\t\t<div class="tree-loader" style="display:none"></div>\t\t\t</div>\t\t\t<div class="tree-item" style="display:none;">\t\t\t\t' + (null == t['unselected-icon'] ? '' : '<i class="' + ace.vars.icon + t['unselected-icon'] + '"></i>') + '\t\t\t\t<div class="tree-item-name"></div>\t\t\t</div>'),
