...
namespace SCWeb.Controllers
{
    ...
    public class GoodsInfoController : Controller
    {
        ...
        public ActionResult SelSCJDBInfo()
        {
            ...
            if (DDLjidu != "0")
            {
                sb.Append(" and SCJD02 like'%" + DDLjidu + "%'");
            }
            //添加工厂搜索
            if (txtgc != "")
            {
        ...
        public ActionResult GetEditSCJDB(Models.BPMSCJDBModels SModel)
        {
            string sql = @"update dbo.BPM_SCJDB set SCJD01=@SCJD01,SCJD02=@SCJD02,SCJD03=@SCJD03,SCJD04=@SCJD04,SCJD05=@SCJD05,SCJD06=@SCJD06,
                              SCJD07 = @SCJD07,SCJD08 = @SCJD08,SCJD09 = @SCJD09,SCJD10 = @SCJD10,SCJD11 = @SCJD11,SCJD12 = @SCJD12,SCJD93 = @SCJD93 where id = @id";
            SqlParameter[] param = new SqlParameter[]
            {
                    new SqlParameter("@SCJD01", string.IsNullOrWhiteSpace(SModel.SCJD01) == true ? "" : SModel.SCJD01),
        ...
        {
            string sql = "select SCJD02 as 波段,SCJD03 as 品牌,SCJD04 as 加工方式,SCJD06 as 款式,SCJD05 as 款号,SCJD07 as 颜色,SCJD08 as '110/S',SCJD09 as '120/M',SCJD10 as '130/L',SCJD11 as '140/XL',SCJD12 as '150/均码',(SCJD08+SCJD09+SCJD10+SCJD11+SCJD12) as 合计,SCJD01 as 商品交期,SCJD93 as 商品年份 from BPM_SCJDB where status<>0 ";
        ...
        public ActionResult GetEditPDSCJDB(Models.BPMSCJDBModels PDSModel)
        {
            string sql = @"update dbo.BPM_SCJDB set SCJD21=@SCJD21,SCJD94=@SCJD94,SCJD95=@SCJD95,SCJD96=@SCJD96,SCJD97=@SCJD97,SCJD98=@SCJD98,SCJD22=@SCJD22,SCJD23=@SCJD23,SCJD24=@SCJD24,SCJD34=@SCJD34,
                          ...
                          ,SCJD51 = @SCJD51,SCJD52 = @SCJD52,SCJD53 = @SCJD53,SCJD54=@SCJD54,SCJD55 = @SCJD55,SCJD56 = @SCJD56,SCJD57 = @SCJD57,
                           SCJD67 = @SCJD67,SCJD75 = @SCJD75,SCJD86 = @SCJD86,SCJD87 = @SCJD87,SCJD106 = @SCJD106,SCJD107 = @SCJD107 where id=@id ";
        ...
        {
            string sql = "select SCJD02 as 波段,SCJD03 as 品牌,SCJD04 as 加工方式,SCJD06 as 款式,SCJD05 as 款号,SCJD07 as 颜色,(SCJD08+SCJD09+SCJD10+SCJD11+SCJD12) as 商品下单,SCJD94 as '110/S',SCJD95 as '120/M',SCJD96 as '130/L',SCJD97 as '140/XL',SCJD98 as '150/均码',(SCJD94+SCJD95+SCJD96+SCJD97+SCJD98) as 已发数量,((SCJD94+SCJD95+SCJD96+SCJD97+SCJD98)-(SCJD08+SCJD09+SCJD10+SCJD11+SCJD12)) as 物控下单欠数,SCJD22 as 工厂,SCJD23 as 合同货期,SCJD24 as 跟单员,SCJD99 as 技术部提供用量,SCJD100 as 物控下采购建议单,SCJD34 as 技术部下单期,SCJD35 as 批颜色,SCJD36 as 批产前办,SCJD37 as 提供检测报告日期,SCJD38 as 洗水唛时间,SCJD104 as 贴纸时间,SCJD39 as 物控下单日期,SCJD40 as 齐料日期,SCJD102 as 财务部付款时间,SCJD41 as 外发下单日期,SCJD47 as 产前样提供日期,SCJD48 as 产前OK日期,SCJD08 as '110/S下单',SCJD09 as '120/M下单',SCJD10 as '130/L下单',SCJD11 as '140/XL下单',SCJD12 as '150/均码下单',(SCJD08+SCJD09+SCJD10+SCJD11+SCJD12) as 生产下单总数,SCJD50 as '110/S实裁',SCJD51 as '120/M实裁',SCJD52 as '130/L实裁',SCJD53 as '140/XL实裁',SCJD54 as '150/均码实裁',(SCJD50+SCJD51+SCJD52+SCJD53+SCJD54) as 实裁合计,SCJD55 as 裁剪差异数,SCJD56 as 差异原因,SCJD57 as 生产异常,SCJD67 as 品控签单日期,SCJD107 as 工厂送货日期,SCJD106 as 工厂送货总数,SCJD75 as 对账时间,SCJD86 as 延期备注,SCJD87 as 尾数状态 from BPM_SCJDB where status<>0 ";
            HSSFWorkbook book = GetExcel(sql);
        ...
        {
            string sql = "select name,lieName from BPM_LieName where status =1 order by sumList ";
            DataTable dt = SqlHelper.SelectTable(sql);
            string lie = "/";
            string lieTow = "、";
            string sqls = "select ";
            ...
            HSSFWorkbook book = GetExcel(sqls);
