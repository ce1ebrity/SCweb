...
namespace WebApplication1.Controllers
{
    public class WeixinController : Controller 
    {
        ...
        public ActionResult Post(PostModel postModel)
        {
            ...
            postModel.AppId = WebConfigurationManager.AppSettings["WeixinAppId"];//根据自己后台的设置保持一致
            ...
            var messageHandler = new SCWeb.WeiXin.CustomMessageHandler(Request.InputStream, postModel);//接收消息
