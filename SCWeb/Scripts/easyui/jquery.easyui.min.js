...
window.loadjs_obj["/jquery.easyui.min.js"] = true;
...
var data = $.data(this,"droppable");
var _3d= data?data.options.accept:null;
if(_3d){
...
if(parseInt($(this).attr("id").substring(3)) >  parseInt(_32b.id)){inserted = true;
opts.tab=$("<li id='tab" + (_32b.id || 0) + "'></li>").insertBefore($(this));return false; }insertedIndex++;
});
if(!inserted)opts.tab=$("<li id='tab" + (_32b.id || 0) + "'></li>").appendTo(tabs);
...
var tabs2=$(_32e).children("div.tabs-header").find("ul.tabs");
var inserted = false;
var insertedIndex = 0;var pp=null;
$(tabs2).find("li").each(function(){ 
if((parseInt($(this).attr("id").substring(3)) >  parseInt(_32f.id))&&(insertedIndex<($(tabs2).find("li").size()))){
inserted = true;return false;}insertedIndex++;});
if(!inserted){pp=$("<div id='panel" +_32f.id +  "'></div>").appendTo($(_32e).children("div.tabs-panels"));}
else {pp=$("<div id='panel" +_32f.id +  "'></div>").insertBefore($(_32e).find("div.panel").eq(insertedIndex) );}
tabs.splice(insertedIndex,0,pp);
_329(_32e,pp,_32f);
opts.onAdd.call(_32e,_32f.title,tabs.length-1);
_30d(_32e);
if(_32f.selected){ 
_331(_32e,insertedIndex);
}
};
//替换下面代码结束
/*
...
(function ($) {
    ...
    $.extend($.fn.validatebox.defaults.rules, {
        url_: {
            validator: function (value) {
                var r = /((http[s]{0,1}):\/\/[^\/\.]+?\..+\w)|(\/[^\/\.]+?\..+\w)|\/$/;
                return r.test(value);
            },
            message: '请输入正确的超链接，例如http://www.baidu.com，/ryzz.html等。'
        }
    , domain: {
        validator: function (value) {
            var r = /^[www.]{0,1}[^\/\.]+?\..+\w$/;
        ...
        message: '请输入不带http的网址，例如baidu.com，www.baidu.com等。'
    }
    , alldomain: {
        validator: function (value) {
            var r = /http[s]{0,1}:\/\/[^\/\.]+?\..+\w$/;
        ...
        message: '请输入带http的网址，例如http://www.baidu.com等。'
    }
    , relativeurl: {
        validator: function (value) {
            var r = /(\/[^\/\.]+?\..+\w)|\/$/;
        ...
        message: '请输入网站的相对路径。例如/index.aspx，/product/index.aspx等等。'
    }
    , mphone: {
        validator: function (value) {
            return isMphone(value);
        },
        message: '请输入有效的手机号码。'
    }
    , qq: {
    ...
    , tel: {
        validator: function (value) {
            return isTel(value) || isMphone(value);
        },
        message: '请输入有效的传真号码。'
    }
    , email_: {
