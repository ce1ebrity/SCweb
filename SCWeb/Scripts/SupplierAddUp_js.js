...
function BtnDel(obj) {
    layer.open({
        ...
        yes: function (index, layero) {
            $.get("/Supplier/DelGYSGCGLMX", { id: obj }, function (data) {
                if (data == "success") {
                    layer.alert("删除成功");
...
function EditSupplier(Eid) {
    ...
    var ywType = str.substring(0, str.length - 1);//选中的业务种类值
    ...
    else if ($("#GYSGC03").val() == "") { layer.alert("请输入公司名称!"); }
    ...
    //else if ($("#GYSGC42").val() == "") { layer.alert("请输入放样周期有胚布!"); }
    //else if ($("#GYSGC43").val() == "") { layer.alert("请输入放样周期无胚布!"); }
    //else if ($("#GYSGC44").val() == "") { layer.alert("请输入大货生产周期有胚布!"); }
    //else if ($("#GYSGC45").val() == "") { layer.alert("请输入大货生产周期无胚布!"); }
    ...
    //    layer.alert("放样周期有胚布格式不正确!");
    //}
    //else if (!(/^\d+(\.\d+)?$/.test($("#GYSGC43").val()))) {
    //    layer.alert("放样周期无胚布格式不正确!");
    //}
    //else if (!(/^\d+(\.\d+)?$/.test($("#GYSGC44").val()))) {
    //    layer.alert("大货生产周期有胚布格式不正确!");
    //}
    //else if (!(/^\d+(\.\d+)?$/.test($("#GYSGC45").val()))) {
    //    layer.alert("大货生产周期无胚布格式不正确!");
    //}
